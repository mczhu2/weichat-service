...
@ApiModel(description = "发送小程序消息接口请求参数")
public class SendAppMessageRequest extends BaseRequest {
    ...
    @ApiModelProperty(value = "小程序原始ID", required = true, example = "gh_1234567890@app")
