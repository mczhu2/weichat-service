...
SaveHostKey=0
[BELL]
FilePath=D:\\soft\\trae\\wechat-service\\tmp-heyuan-audio-log.txt
RepeatTime=3
FlashWindow=0
BellMode=1
IgnoreTime=3
...
Password=1FWpPusxYTw/ey9foV++H8Su5wK8hwlzQC31ZvyTmn37SFSgM38nWl+RUw==
...
ExpectSend_Count=0
AuthMethodList=01
ScriptPath=D:\\soft\\trae\\wechat-service\\tmp-heyuan-audio-log.py
UserKey=
UserName=root
[LOGGING]
FilePath=D:\\soft\\trae\\wechat-service\\tmp-heyuan-audio-log.txt
