 ...
 */
@Mapper
public interface WxMessageInfoMapper {
    /**
     * 新增微信消息信息
     ...
     * @return 影响行数
     */
    int batchInsert(@Param("list") List<WxMessageInfo> list);
     ...
     * @return 微信消息信息列表
     */
    List<WxMessageInfo> selectBySendTimeRange(@Param("startTime") Long startTime, @Param("endTime") Long endTime);
}
